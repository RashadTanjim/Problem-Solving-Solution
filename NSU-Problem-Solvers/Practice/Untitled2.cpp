...
void course_drop()
{
    string name,email,program,address,department; //these variable has only character value
    int phone_number,select,id; //this variable has int value
    string course;
...
void course_add()
{
    string name,course,email,program,address,department; //these variable has only character value
    int phone_number,select,id; //this variable has int value
    string a; // need a string to calculate digit of phone number
